...
If the NVM Host Development Kit being used is other than [SAM L10 Xplained Pro Evaluation Kit](https://www.microchip.com/DevelopmentTools/ProductDetails/dm320204) then follow the steps mentioned in [Configuring NVM Host application project](GUID-E614E914-48BF-43EC-87B8-BAE0F81B83AE.md#)

1.  Open the NVM host application project *host\_app\_nvm/firmware/sam\_l10\_xpro.X* in the IDE
...
2.  Build and program the NVM host application using the IDE on to the Host development kit
    ...
    -   The prebuilt test application image available under **host\_app\_nvm/firmware/src/test\_app\_images/image\_pattern\_hex\_sam\_l10\_xpro.h** will be programmed on to the Target development kit with default **host\_app\_nvm** project configuration
...
1.  Open the bootloader project *bootloader/firmware/sam\_l10\_xpro.X* in the IDE
...
5.  Once the programming is complete,
    ...
    -   If the test application is programmed then **LED0** should start blinking and you should see below output on the **Target development kit** console
        ...
        ![output](GUID-FB891F17-6A41-45FA-9553-03D23A98CEC8-low.png)
...
-   To bootload any application other than **host\_app\_nvm/firmware/src/test\_app\_images/image\_pattern\_hex\_sam\_l10\_xpro.h** refer to [Application Configurations](GUID-DBC21340-BFFA-466C-9909-E696C180A54E.md)
